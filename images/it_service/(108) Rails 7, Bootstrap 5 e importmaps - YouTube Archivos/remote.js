...
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},H6=function(){var a=w_a();
a&&a(!1,"No cast extension found")},I6=function(){if(A_a){var a=2,b=w_a(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;x_a("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",H6,c)}},B_a=function(){I6();
var a=z_a();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");G6(a)},D_a=function(){I6();
var a=z_a();a.push.apply(a,g.v(C_a.map(y_a)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");G6(a)},E_a=function(){this.j=J6();
...
a.D&&(c=null);var d=(0,g.Qa)(a.s0,a);c||(c=new g.Hk("//www.google.com/images/cleardot.gif"),g.C.location&&"http"==g.C.location.protocol||g.Ik(c,"https"),m6(c));c0a(c.toString(),d)}else S6(2);a.ag=0;a.D&&a.D.hL(b);m0a(a);g0a(a)},m0a=function(a){a.ag=0;
...
a.Qg&&(c=null);var d=(0,g.Qa)(a.r0,a);c||(c=new g.Hk("//www.google.com/images/cleardot.gif"),m6(c));C0a(c.toString(),1E4,d)}else u7(2);R0a(a,b)},R0a=function(a,b){a.j=0;
...
b=g.U(b,128)?g.JF("Error en $RECEIVER_NAME",c):b.Nc()||g.U(b,4)?g.JF("Reproduciendo en $RECEIVER_NAME",c):g.JF("Conectado a $RECEIVER_NAME",c);a.Ka("statustext",b);a.j.show()}else a.j.hide()},O9=function(a,b){g.mN.call(this,"Reproducir en",0,a,b);
...
O9.prototype.yk=function(a){return"cast-selector-receiver"===a?"Transmitir\u2026":this.gq[a].name};
